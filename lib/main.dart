      ...
      bottomNavigationBar: Align(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              SvgPicture.asset("assets2/Home.svg",width: 25,height: 22,),
              SvgPicture.asset("assets2/chat.svg",width: 25,height: 22,),
              SvgPicture.asset("assets2/main.svg",width: 25,height: 22,),
              SvgPicture.asset("assets2/profile.svg",width: 25,height: 22,),
            ],
          ),
        ),
      ),
            ...
            children: [
              Stack(
                ...
                children: [
                  ...
                  Image(
                    image: AssetImage("assets2/tobaco.png"),
                    width: 169,
                    height: 153,
                  ),
                ],
...
class Chef1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Image(
          image: AssetImage("assets2/chef1.png"),
          width: 83,
          height: 74,
        ),
        Text(
...
class Chef4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Image(
          image: AssetImage("assets2/chef4.png"),
          width: 83,
          height: 74,
        ),
        Text(
...
class Chef3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Image(
          image: AssetImage("assets2/chef3.png"),
          width: 83,
          height: 74,
        ),
        Text(
...
class Chef2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Image(
          image: AssetImage("assets2/chef2.png"),
          width: 83,
          height: 74,
        ),
        Text(
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        Image(
          image: AssetImage("assets2/mojito.png"),
          width: 169,
          height: 153,
        ),
      ],
